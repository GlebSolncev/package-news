...
class CategoryPolicy
{
    ...
    {
        if ($user->canDo('news.category.view') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        return  $user->canDo('news.category.create');
    }
    ...
    {
        if ($user->canDo('news.category.edit') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        if ($user->canDo('news.category.verify')) {
            return true;
        }
    ...
    {
        if ($user->canDo('news.category.approve')) {
            return true;
        }
